...

{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        switch (direction)
        {
            case GeneralDataController.DIRECTION.RIGHT: PlayerController.Instance.direction = transform.right; break;
            case GeneralDataController.DIRECTION.LEFT: PlayerController.Instance.direction = -transform.right; break;
            case GeneralDataController.DIRECTION.FORWARD: PlayerController.Instance.direction = transform.forward; break;
            case GeneralDataController.DIRECTION.BACK: PlayerController.Instance.direction = -transform.forward; break;
        }
